...
public class BaseServiceImpl<T> implements BaseService<T> {
	...
	@Override
	public Integer getTotalCountByCriteria(List<Condition> conditions) {
		return baseDao.getTotalCountByCriteria(conditions);
	}

	@Override
	public Object getObjBySql(String sql) {
		return baseDao.getObjBySql(sql);
	}

	@Override
	public List<Object> getObjsBySql(String sql) {
		return baseDao.getObjsBySql(sql);
	}
